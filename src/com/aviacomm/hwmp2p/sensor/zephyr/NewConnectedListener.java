		...
		_protocol.addZephyrPacketEventListener(new ZephyrPacketListener() {
			public void ReceivedPacket(ZephyrPacketEvent eventArgs) {
				...
				case GP_MSG_ID:
					 ...
					 * Posture******************************************
					 * 
					 * int PostureInt = GPInfo.GetPosture(DataArray); text1 =
					 * _aNewHandler.obtainMessage(POSTURE);
					 * b1.putString("Posture", String.valueOf(PostureInt));
					 * text1.setData(b1); _aNewHandler.sendMessage(text1);
					 * System.out.println("Posture is "+ PostureInt);
					 * //***************Displaying the Peak
					 * Acceleration******************************************
					 * 
					 * double PeakAccDbl =
					 * GPInfo.GetPeakAcceleration(DataArray); text1 =
					 * _aNewHandler.obtainMessage(PEAK_ACCLERATION);
					 * b1.putString("PeakAcceleration",
					 * String.valueOf(PeakAccDbl)); text1.setData(b1);
					 * _aNewHandler.sendMessage(text1);
				...
				case ACCEL_100mg_MSG_ID:
					/* Do what you want. Printing Sequence Number for now */
					System.out
							.println("Accelerometry Packet Sequence Number is "
